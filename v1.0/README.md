...
**Neobrutalism** (since 2025-07-16) — Light-only theme with warm off-white surface (`#FBFBF9`), bold 3px navy borders (`#1C293C`), yellow primary (`#FDC800`), purple secondary (`#432DD7`), Inter + JetBrains Mono typography. Offset hover states (`translate(-2px, -2px)`), sharp corners (4px max), 3px focus outlines. No gradients, glows, or subtle shadows.
...
| v1.0 | 🟢 Active | `v1.0/` | Capture tab, context menu, keyboard shortcut, full-window popup, sidebar toggle, slash commands (`/melt-tabs`, `/summarize`, `/todo`, `/ask`), Melted Tabs page, collapsible preview with toggle preserved, auto-growing composer, status fade animation, Send-to-page popup overlay, **Neobrutalism design migration (2025-07-16)** |
