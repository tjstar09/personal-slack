import type { Bookmark, BookmarkKind, Conversation, DraftPayload, Message, Page, WorkspaceData } from './types';
...
export const normalizeWorkspace = (input: WorkspaceData): WorkspaceData => {
...
const readableTitleFromUrl = (url: string) => {
  try {
